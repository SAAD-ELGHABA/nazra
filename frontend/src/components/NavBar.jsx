        ...
        <header className='h-[60px] w-full  flex items-center justify-between px-4 md:px-6 bg-white shadow-md sticky top-0 z-50'>
            ...
            <nav className='hidden md:flex items-center h-full gap-8 lg:gap-16'>
                <ul className='flex items-center gap-4 lg:gap-6'>
                    <li><Link to={'#'} className='hover:text-gray-600'>Home Page</Link></li>
                    <li><Link to={'#'} className='hover:text-gray-600'>Shop Now</Link></li>
                    <li><Link to={'#'} className='hover:text-gray-600'>About Us</Link></li>
                    <li>
                        <Link to={'#'} className='flex items-center gap-1 hover:text-gray-600'>
