...
export default function HomeProductCard({ product, inFavorites, onFavorite, onAdd }) {
  ...
  return (
    <article className="group min-w-[76vw] snap-start sm:min-w-[310px] lg:min-w-0">
      ...
      <div className="pt-3">
        ...
        <button type="button" onClick={() => onAdd(product)} className="mt-3 flex min-h-11 w-full items-center justify-center gap-2 bg-[#111] px-4 text-xs font-semibold text-white transition hover:bg-stone-700 focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:bg-stone-400">
