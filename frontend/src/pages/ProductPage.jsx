    ...
    <div className="min-h-screen">
      ...
      <div className="w-[90%] mx-auto">
        <div className="md:w-3/4 w-full">
          <h2 className="font-semibold text-lg md:text-2xl text-gray-900 mb-3 border-gray-300 border-b pb-2">
            Frame Description
          </h2>

          <p className="text-gray-700 leading-relaxed text-sm md:text-base pr-2">
            {i18n.language === "en"
